...
define(dependencies, function(){
   ...
   var RestaurantController = function($scope, $rootScope, $log,$modal,$window,Upload){
...
//	   });
	   ...
	   $scope.options = {mapMaker: true, backgroundColor: 'black'};
	    ...
	    var reviewModal = $modal({templateUrl: 'modules/restaurant/tmpl/modal-res-review.html', show: false, controller: 'reviewController'});
	    $scope.writeReview = function(){
	    	reviewModal.show();
	    }
   };
    
   return ["$scope","$rootScope","$log","$modal","$window","Upload", RestaurantController];
});
